...
const (
	...
	LogSummarySubmit       = "summary submit by=%s recording=%d review_status=%s"
	LogSummaryApprove      = "summary approve by=%s recording=%d"
	LogSummaryReject       = "summary reject by=%s recording=%d reason=%s"
