...
export const REVIEW_STATUS_UNSUBMITTED = 'unsubmitted'
...
export const REVIEW_STATUS_OPTIONS = [
  ...
  { value: REVIEW_STATUS_UNSUBMITTED, label: '未提交' },
] as const

export const REVIEW_STATUS_TEXT: Record<string, string> = {
  [REVIEW_STATUS_UNSUBMITTED]: '未提交',
  [REVIEW_STATUS_PENDING]: '待审',
...
export type ReviewStatus =
  | typeof REVIEW_STATUS_UNSUBMITTED
  | typeof REVIEW_STATUS_PENDING
  | typeof REVIEW_STATUS_APPROVED
  | typeof REVIEW_STATUS_REJECTED
